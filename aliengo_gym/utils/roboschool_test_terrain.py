...
class Terrain:
    def __init__(
        ...
        center_x = start_x + int(6.0 / self.horizontal_scale)
        center_y = start_x + int(8.0 / self.horizontal_scale)
        ...
        box1_center_x = start_x + int(2.0 / self.horizontal_scale)
        box1_center_y = start_y + int(9.0 / self.horizontal_scale)
        ...
        box2_center_x = start_x + int(10.0 / self.horizontal_scale)
        box2_center_y = start_y + int(2.0 / self.horizontal_scale)
        ...
        box3_center_x = start_x + int(2.0 / self.horizontal_scale)
        box3_center_y = start_y + int(2.0 / self.horizontal_scale)
        ...
        box4_center_x = start_x + int(5.0 / self.horizontal_scale)
        box4_center_y = start_y + int(12.0 / self.horizontal_scale)
        ...
        box5_center_x = start_x + int(6.8 / self.horizontal_scale)
        box5_center_y = start_y + int(9.0 / self.horizontal_scale)
        ...
        box6_center_x = start_x + int(2.0 / self.horizontal_scale)
        box6_center_y = start_y + int(13.0 / self.horizontal_scale)
        ...
        box7_center_x = start_x + int(9.0 / self.horizontal_scale)
        box7_center_y = start_y + int(14.0 / self.horizontal_scale)
        ...
        box8_center_x = start_x + int(3.0 / self.horizontal_scale)
        box8_center_y = start_y + int(6.0 / self.horizontal_scale)
...
def export_occupancy_map(output_path="roboschool_occupancy_map.npy"):
    terrain = Terrain()
    binary_map = (terrain.height_field_raw > 0).astype(np.uint8)
    np.save(output_path, binary_map)
    print(f"Saved occupancy map to {output_path}")
    print(f"shape={binary_map.shape}, horizontal_scale={terrain.horizontal_scale}")


if __name__ == "__main__":
    export_occupancy_map("roboschool_occupancy_test_map.npy")
